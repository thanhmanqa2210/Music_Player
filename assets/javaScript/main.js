  ...
  songs: [
    {
      ...
      path: "../assets/songs/Hom-Nay-Toi-Buon-Phung-Khanh-Linh.mp3",
      image: "../assets/img/PhungKhanhLinh_HomNayToiBuon.png",
    },
    {
      name: "Sài Gòn Hôm Nay Mưa",
      singer: "JSOL & Hoàng Duyên",
      path: "../songs/JSOL & HOÀNG DUYÊN - SÀI GÒN HÔM NAY MƯA - Official MV.mp3",
    ...
    },
    {
      name: "Sugar",
      singer: "Maroon 5",
      path: "../assets/songs/Maroon 5 - Sugar (Lyrics).mp3",
      image: "../assets/img/Sugar.jpg",
    },
    {
      name: "Worth It",
      singer: "Fifth Harmony",
      path: "../assets/songs/Fifth Harmony - Worth It (Official Video) ft. Kid Ink.mp3",
      image: "../assets/img/worthIt.jpg",
    },
    {
      name: "Astronaut In The Ocean",
      singer: "Masked Wolf",
      path: "../assets/songs/Masked Wolf - Astronaut In The Ocean (Official Music Video).mp3",
      image: "../assets/img/astronaut.jpg",
    },
    {
      name: "See You Again",
      singer: "Wiz Khalifa",
      path: "../assets/songs/Wiz Khalifa - See You Again ft. Charlie Puth [Official Video] Furious 7 Soundtrack.mp3",
    ...
    },
    {
      ...
      path: "../assets/songs/► Imagine Dragons - Believer (with lyrics).mp3",
      image: "../assets/img/Believer.jpg",
    },
    {
      name: "Maria",
      singer: "Hwa Sa",
      path: "../assets/songs/[MV] Hwa Sa(화사) _ Maria(마리아).mp3",
      image: "../assets/img/Maria.jpg",
    },
    {
      name: "Perfect",
      singer: "Ed Sheeran",
      path: "../assets/songs/Ed Sheeran - Perfect (Official Music Video).mp3",
      image: "../assets/img/perfect.webp",
    },
    {
      name: "The Chainsmokers & Coldplay",
      singer: "Closer ft. Halsey",
      path: "../assets/songs/The Chainsmokers - Closer (Lyrics) ft. Halsey.mp3",
      image: "../assets/img/TheChainMokers.jpg",
    },
  ],
